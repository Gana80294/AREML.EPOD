...
namespace AREML.EPOD.Data.Repositories
{
    public class MobileRepository : IMobileRepository
    {
        ...
        public async Task<AttachmentResponse> DownloadPODDocument(int HeaderID, int AttachmentID)
        {
            try
            {
                ...
                {
                    response.FileName = p_INV_ATTACHMENT.ATTACHMENT_NAME;
                    response.FileContent = p_INV_ATTACHMENT.ATTACHMENT_FILE;
                    response.Extension = p_INV_ATTACHMENT.DOCUMENT_TYPE;
                    return response;
                }
                else
